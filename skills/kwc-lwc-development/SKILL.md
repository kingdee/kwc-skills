...
description: KWC LWC 框架专用开发 Skill。仅当项目已确认使用 LWC 框架（通过 .kd/config.json 中的 framework=lwc 配置或 scaffold Skill 的框架识别结果）时才应加载本 Skill。本 Skill 提供 KWC LWC 项目的开发规范和组件使用指南（详见 rule.md）。
---
