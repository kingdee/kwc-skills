...
export default class ExpandTable extends KingdeeElement {
    columns = [
...
export default class ExpandByClickTable extends KingdeeElement {
    columns = [
...
export default class PartialExpandTable extends KingdeeElement {
    columns = [
        { title: '姓名', dataIndex: 'name', width: 150 },
        { title: '年龄', dataIndex: 'age', width: 100 },
...
export default class DefaultExpandedTable extends KingdeeElement {
    columns = [
        { title: '姓名', dataIndex: 'name', width: 150 },
...
export default class ExpandAllTable extends KingdeeElement {
    columns = [
        { title: '姓名', dataIndex: 'name', width: 150 },
