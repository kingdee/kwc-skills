...
export default class BorderedTable extends LightningElement {
    columns = [
...
export default class NoHeaderTable extends LightningElement {
    columns = [
...
export default class CustomRowKeyTable extends LightningElement {
    columns = [
